    ...
    return (
        <div className="container mx-auto">
            <div className="mb-10 mx-2 md:mx-0">
                <h1 className=" text-2xl text-center md:text-left md:text-4xl font-bold text-black">Explore the <span className="bg-gradient-to-r from-[#ec4899] from-0% to-[#8b5cf6] to-100% bg-clip-text text-transparent">Technologies</span></h1>
                <p className="mt-2 text-sm md:text-base text-gray-600">Pick one technology per category to build your ideal stack.</p>
            </div>
